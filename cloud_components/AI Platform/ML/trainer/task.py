...
def train_and_maybe_evaluate(hparams):
    ...
    def train_input(): return model.input_fn(
        hparams.train_files,
        tf_transform_output,
        batch_size=TRAIN_BATCH_SIZE
    )

    def eval_input(): return model.input_fn(
        hparams.eval_files,
        tf_transform_output,
    ...
    def serving_receiver_fn(): return model.example_serving_receiver_fn(
        tf_transform_output)
    ...
    def eval_input_receiver_fn(): return model.eval_input_receiver_fn(
        tf_transform_output)
